...
click "More info" -> "Run anyway." The game is signed
with a self-signed certificate from Nikita Games.
...
Controls:
  ...
  E           — Revive fallen friend / Talk to NPC / Chest / Interact
...
Discord Rich Presence works out of the box (can be disabled in settings).